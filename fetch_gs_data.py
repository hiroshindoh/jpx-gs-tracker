...
def parse_fut_oi(raw):
    ...
    month_map = {"01月": "2601", "02月": "2602", "03月": "2603", "04月": "2604", "05月": "2605", "06月": "2606", "07月": "2607", "08月": "2608", "09月": "2609", "10月": "2610", "11月": "2611", "12月": "2612"}
...
def parse_vol(raw, date_str):
    ...
    ws = wb.active
    futures_map = {
        "NK225F":  {"2606": "L6", "2607": "L7", "2609": "L9", "2612": "L12"},
        "NK225MF": {"2604": "M4", "2605": "M5", "2606": "M6", "2607": "M7", "2608": "M8", "2609": "M9"},
        "TOPIXF":  {"2606": "T6", "2607": "T7", "2609": "T9", "2612": "T12"},
    }
    history_day = {}
    opt_list = []
    for row in ws.iter_rows(values_only=True):
